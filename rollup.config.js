...
esmConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/mjs/pdfkit-commonmark.mjs',
    format: 'esm'
});
...
esmProdConfig.output = Object.assign({}, esmConfig.output, {
    file: 'dist/mjs/pdfkit-commonmark.min.mjs',
    sourcemap: false
});
...
umdConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/umd/pdfkit-commonmark.js',
    format: 'umd'
});
umdConfig.plugins = [
...
umdProdConfig.output = Object.assign({}, umdConfig.output, {
    file: 'dist/umd/pdfkit-commonmark.min.js',
    sourcemap: false
});
...
if (process.env.SERVE) {
    ...
    serveConfig.output = Object.assign({}, commonConfig.output, {
        file: 'dist/render/pdfkit-commonmark.iife.js',
        format: 'iife'
    });
    serveConfig.plugins = [
        eslint({
