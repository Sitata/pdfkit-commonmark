(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['pdfkit-commonmark'] = factory());
  ...
  function _deepDefaults(dest, src) {
      if(lodash.isUndefined(dest) || lodash.isNull(dest) || !lodash.isPlainObject(dest)) { return dest; }

      lodash.each(src, function(v, k) {
          if(lodash.isUndefined(dest[k])) {
              dest[k] = v;
  ...
  var executeOperation = (function (operation, doc, options) {
    ...
    if (operation.font) {
      doc.font(forInternalName(operation.font, options));
    }
    ...
    if (operation.listItem) {
      ...
      var renderArabic = function renderArabic(doc) {
        var oldX = doc.x;
        var x = doc.x - arabicIndent(doc, operation.listItemCount);
        var y = doc.y;
    ...
    if (operation.listDepth >= 0) {
      var indent$1 = indent(doc, operation.listItemStyle, operation.listItemCount, options.fontSize);
      doc.x = doc.page.margins.left + operation.listDepth * indent$1;
    }
  ...
  var CommonmarkPDFKitRenderer = /*#__PURE__*/function () {
    function CommonmarkPDFKitRenderer() {
      ...
      classCallCheck(this, CommonmarkPDFKitRenderer);
    ...
    createClass(CommonmarkPDFKitRenderer, [{
      key: "operations",
      value: function operations(nodeTree) {
        ...
        var PDFOperationPropertyStack = /*#__PURE__*/function () {
          function PDFOperationPropertyStack() {
            classCallCheck(this, PDFOperationPropertyStack);
          ...
          createClass(PDFOperationPropertyStack, [{
            key: "push",
            ...
            case 'heading':
              {
                if (event.entering) {
                  operations.push(stack.push({
                    font: forHeadingLevel(node.level),
                    fontSize: sizeForHeadingLevel(node.level),
                    continued: true
                  }).get());
                } else {
                  stack.pop();
        ...
        var removeRedundancies = function removeRedundancies(operation, index, operations) {
          ...
          if (previousState) {
            ...
            var reducedOperation = propertiesToKeep.reduce(function (reduced, property) {
              return Object.assign(reduced, defineProperty({}, property, operation[property]));
      ...
      value: function dimensionsOfMarkdown(doc, nodeTree, pdfkitOptions) {
        ...
        operations.forEach(function (op) {
          ...
          if (op.font) {
            var resolvedFont = forInternalName(op.font, _this.options);
          ...
          if (op.text) {
            ...
            if (!op.continued) {
              ...
              if (pdfkitOptions && Object.prototype.hasOwnProperty.call(pdfkitOptions, 'width')) {
                textOptions.width = pdfkitOptions.width - indent$1;
          ...
          if (op.list === true) {
            indent$1 = op.listDepth * indent(doc, op.listStyleType, op.listItemCount, pdfkitOptions.fontSize);
          }
      ...
      value: function render(doc, nodeTree, pdfkitOptions) {
        ...
        operations.forEach(function (op) {
          executeOperation(op, doc, Object.assign({}, _this2.options, {
...
//# sourceMappingURL=pdfkit-commonmark.js.map
